...
awk '{print($4, 6370-$3)}' pick_files/moho_depths_Cross-section_24.txt | gmt psxy -Gwhite -Sd.25 -W1.2p,black -l"Moho picks"
awk '{print($4, 6370-$3)}' pick_files/unc_moho_depths_Cross-section_24.txt | gmt psxy -Gdimgrey -Sd.25 -W1.2p,black -l"Unc. Moho picks"
...
awk '{print($4, 6370-$3)}' pick_files/moho_depths_Cross-section_23.txt| gmt psxy -Gwhite -Sd.25 -W1.2p,black
awk '{print($4, 6370-$3)}' pick_files/unc_moho_depths_Cross-section_23.txt | gmt psxy -Gdimgrey -Sd.25 -W1.2p,black
gmt text -Dj15p -F+cLT+jTL+f17p+t"E"
gmt text -Dj20p -F+cRT+jTR+f17p+t"W"
#
...
awk '{print($4, 6370-$3)}' pick_files/moho_depths_Cross-section_22.txt| gmt psxy -Gwhite -Sd.25 -W1.2p,black
awk '{print($4, 6370-$3)}' pick_files/unc_moho_depths_Cross-section_22.txt | gmt psxy -Gdimgrey -Sd.25 -W1.2p,black
gmt text -Dj15p -F+cLT+jTL+f17p+t"E"
gmt text -Dj20p -F+cRT+jTR+f17p+t"W"
...
awk '{print($4, 6370-$3)}' pick_files/moho_depths_Cross-section_21.txt | gmt psxy -Gwhite -Sd.25 -W1.2p,black
awk '{print($4, 6370-$3)}' pick_files/unc_moho_depths_Cross-section_21.txt | gmt psxy -Gdimgrey -Sd.25 -W1.2p,black
gmt text -Dj15p -F+cLT+jTL+f17p+t"E"
gmt text -Dj20p -F+cRT+jTR+f17p+t"W"
