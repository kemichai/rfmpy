...
awk '{print($4, 6370-$3)}' pick_files/picks_cc31.txt | gmt psxy -Gwhite -Sd.25 -W1.2p,black -l"Moho picks"
awk '{print($4, 6370-$3)}' pick_files/unc_picks_cc31.txt | gmt psxy -Gdimgrey -Sd.25 -W1.2p,black -l"Unc. Moho picks"
...
awk '{print($4, 6370-$3)}' pick_files/picks_cc30.txt| gmt psxy -Gwhite -Sd.25 -W1.2p,black
awk '{print($4, 6370-$3)}' pick_files/unc_picks_cc30.txt | gmt psxy -Gdimgrey -Sd.25 -W1.2p,black
#
...
awk '{print($4, 6370-$3)}' pick_files/picks_cc29.txt| gmt psxy -Gwhite -Sd.25 -W1.2p,black
awk '{print($4, 6370-$3)}' pick_files/unc_picks_cc29.txt | gmt psxy -Gdimgrey -Sd.25 -W1.2p,black
