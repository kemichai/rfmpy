...
awk '{print($2-43, 6370-$3)}' pick_files/moho_depths_Cross-section_13.txt | gmt psxy -Gwhite -Sd.25 -W1.2p,black -l"Moho picks"
awk '{print($2-43, 6370-$3)}' pick_files/unc_moho_depths_Cross-section_13.txt | gmt psxy -Gdimgrey -Sd.25 -W1.2p,black -l"Unc. Moho picks"
...
awk '{print($2-43, 6370-$3)}' pick_files/moho_depths_Cross-section_12.txt | gmt psxy -Gwhite -Sd.25 -W1.2p,black
awk '{print($2-43, 6370-$3)}' pick_files/unc_moho_depths_Cross-section_12.txt | gmt psxy -Gdimgrey -Sd.25 -W1.2p,black
