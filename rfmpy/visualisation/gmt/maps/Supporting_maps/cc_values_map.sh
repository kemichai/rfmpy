...
gmt makecpt -C../files/bamako.cpt -T0.89/1/0.01 -D+i -I > seis.cpt
...
gmt psscale -Dx9.0/1.9+o0/0i+w1.1i/0.08i+h+e -R -F+gwhite+p1p -J -Cseis.cpt -Bxa0.05f.05 -Bx+l"Average cc values" -O -K  >> $out
...
awk '{print $1, $2, $3}' ../files/cc_values.txt | gmt psxy -i0,1,2 -Si.2 -R -J \
