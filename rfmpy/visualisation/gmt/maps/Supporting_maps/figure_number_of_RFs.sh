...
awk '{print $3, $2, $4}' ../files/number_of_rf_calculated_EASI.txt | gmt psxy -i0,1,2 -St.2 -R -J \
-O -K -W.5p -Cseis.cpt -t0 >> $out
awk '{print $3, $2, $4}' ../files/number_of_rf_calculated_CIFALPS.txt | gmt psxy -i0,1,2 -Ss.2 -R -J \
-O -K -W.5p -Cseis.cpt -t0 >> $out
awk '{print $3, $2, $4}' ../files/number_of_rf_calculated_PACASE.txt | gmt psxy -i0,1,2 -Sd.2 -R -J \
-O -K -W.5p -Cseis.cpt -t0 >> $out
