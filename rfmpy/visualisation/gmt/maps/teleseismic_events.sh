...
#  gmt coast -Rd -JR12c -Bg -Dc -A10000 -Glightgray -Wthinnest
  gmt coast -Rd -JN12c -Bg -Dc -A10000 -Glightgray -Wthinnest
...
#	gmt plot tele_events_sample.txt -h1 -Scc -i1,2,3,4+s0.025 -Gred -Wthinnest
  gmt colorbar -DjLM+w5.0c+jRM+o2.0c/0.1c+e -Cn.cpt -Bx100f20+lDEPTH -By+lkm
...
#	# Fancy line
	gmt plot -B -W2.5p,dodgerblue <<- EOF
	0	45
	20 45
	20	50
	0	  50
