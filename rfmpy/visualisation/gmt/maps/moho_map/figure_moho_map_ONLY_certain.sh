...
grid='-I70+k'
gmt blockmean ../files/moho_picks/moho_depths_CERTAIN.dat -R $grid -Sm -V -C > ship_50k.nc
...
#awk '{print $1, $2, $3}' ../files/moho_picks/moho_depths_CERTAIN.dat | gmt psxy -i0,1,2 -Sc.05 -R -J -O -K -Cseis.cpt -t5 >> $out
