...
gmt psscale -Dx7.0/10.8+o0/0i+w1.2i/0.08i+h+e -R -J  -Cseis.cpt -Bx200f100 -Bx+l"Number of waveforms" \
-O -K --FONT_ANNOT_PRIMARY=8p >> $out
...
gmt pslegend <<END -R -J -Dx.4i/3.1i+w0i/0.0i/TC -C0.07i/0.1i -F+gwhite+pthin -P -O -K >> $out
G -0.05i
