...
echo Plot scale...
gmt psscale -Dx1/10.8+o0/0i+w1.2i/0.08i+h+e -R -J -Cmy_topo.cpt -Bx500f250 -Bx+l"Topography (m)" \
 -O -K --FONT_ANNOT_PRIMARY=8p >> $out
gmt psscale -Dx1/12.4+o0/0i+w1.2i/0.08i+h+e -R -J  -Cseis.cpt -Bx200f100 -Bx+l"Number of waveforms" \
-O -K --FONT_ANNOT_PRIMARY=8p >> $out
...
gmt pslegend <<END -R -J -Dx0.4i/3.1i+w0i/0.0i/TC -C0.07i/0.1i -F+gwhite+pthin -P -O -K >> $out
G -0.05i
H 8 Seismic networks
D0.1i 0.5p
G .04i
