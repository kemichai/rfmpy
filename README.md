...
The Alpine region is based on four temporary seismic networks (i.e., AASN, EASI, CIFALPS, PACASE).
...
DK, LP, and GH developed an updated version of `rfmpy` tailored for studying the MTZ. For more details:
